...
export function createMcpServer(backend) {
  ...
  register('prism_combine', 'Combine selected answers', 'Compile selected complete answers locally, or synthesize them through one provider. Synthesis sends the original prompt, selected answers, ratings, notes and direction. Requires explicit approval for live calls. Prior drafts are preserved.',
